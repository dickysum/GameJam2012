...
{
	public partial class TestEntity : PositionedObject, IDestroyable
	{
...
protected Layer LayerProvidedByContainer = null;
        ...
        public TestEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public TestEntity(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
public static void LoadStaticContent (string contentManagerName)
{
	...
	if (IsStaticContentLoaded == false)
	{
		...
		lock (mLockObject)
		{
			...
			{
				FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("TestEntityStaticUnload", UnloadStaticContent);
...
object GetMember (string memberName)
{
	...
	// Extra classes
	public static class TestEntityExtensionMethods
	{
	}
