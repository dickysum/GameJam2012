...
protected Layer LayerProvidedByContainer = null;
		...
		protected virtual void InitializeEntity(bool addToManagers)
		{
			...
			Barrel = CannonBarrelFile.Sprites.FindByName("cannon_barrell_ggj1").Clone();
			Base = CannonBarrelFile.Sprites.FindByName("cannon_base_ggj1").Clone();
...
// Generated AddToManagers
		...
		public virtual void Destroy()
		{
			...
			if (Base != null)
			{
				SpriteManager.RemoveSprite(Base);
			}
...
public virtual void AddToManagersBottomUp (Layer layerToAddTo)
{
	...
	RotationY = 0;
	RotationZ = 0;
	SpriteManager.AddToLayer(Barrel, layerToAddTo);
	if (Barrel.Parent == null)
	{
		Barrel.AttachTo(this, true);
	}
	SpriteManager.AddToLayer(Base, layerToAddTo);
	if (Base.Parent == null)
	{
		Base.AttachTo(this, true);
	}
	X = oldX;
	Y = oldY;
	Z = oldZ;
...
public virtual void ConvertToManuallyUpdated ()
{
	...
	SpriteManager.ConvertToManuallyUpdated(Base);
}
